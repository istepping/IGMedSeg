...
class Snake:
    ...
    delta = 5  # The weight of the user configured energy.
    ...
    # Constructor
    #################################
    def __init__(self, image=None, closed=True, points=None, search_kernel_size=7):
        """
        Object constructor
        ...
        # 输入初始化点
        self.points = points
        self.SEARCH_KERNEL_SIZE = search_kernel_size
